...
if (use_sasa):
    for element in r_vdW.keys():
        r_vdW[element] =  r_vdW[element] + r_probe
print(r_vdW)
...
#    rab = (area_solute/area_solvent)**(1/2)
    print("rab = ", rab)
    fac = n_rot
    S_rif = n_rot*(S_r*((psi_solute)**(rab/fac)) + S_r_mu*(1 - (psi_solute**(rab/fac))))
...
S_cav1 = -5.365*omega*fac*k
xfac = 3*m.log((pi*m.sqrt(3)/6))/m.log(pi/6)
fac2 = fac*((psi_solute/psi_solvent)**xfac)
#fac2 = fac*((psi_solute/psi_solvent)**(1/2))
#print("fac4 = ", fac2)
S_cav2 = -5.365*omega*fac2*k
fac3 = fac*((psi_solute/psi_solvent)**(1/3))
#print("fac3 = ", fac)
S_cav3 = -5.365*omega*fac3*k
...
S_tot0 = (S_ri0 + S_t + S_cav1 + S_vib)*23.06*1000
S_totf = (S_rif + S_t + S_cav1 + S_vib)*23.06*1000
S_tot1 = (S_ri1 + S_t + S_cav1 + S_vib)*23.06*1000
S_tot2 = (S_ri2 + S_t + S_cav1 + S_vib)*23.06*1000
S_tot3 = (S_ri3 + S_t + S_cav1 + S_vib)*23.06*1000
S_tot4 = (S_ri4 + S_t + S_cav1 + S_vib)*23.06*1000
S_gas = (S_r_gas + S_t_gas + S_vib)*23.06*1000
# Print results
...
print(" --- m = 0 ----")      
print(DS0, DSf, DS1, DS2, DS3, DS4)
#print("Delta S_sol (J) =  ", (S_tot - S_gas)*23.06*1000*4.186)
print(" --- m = 2 ----")      
S_tot0 = (S_ri0 + S_t + S_cav2 + S_vib)*23.06*1000
S_totf = (S_rif + S_t + S_cav2 + S_vib)*23.06*1000
S_tot1 = (S_ri1 + S_t + S_cav2 + S_vib)*23.06*1000
S_tot2 = (S_ri2 + S_t + S_cav2 + S_vib)*23.06*1000
S_tot3 = (S_ri3 + S_t + S_cav2 + S_vib)*23.06*1000
S_tot4 = (S_ri4 + S_t + S_cav2 + S_vib)*23.06*1000
DS0 = S_tot0 - S_gas
DSf= S_totf - S_gas
DS1= S_tot1 - S_gas
DS2 = S_tot2 - S_gas
...
print(" --- m = 3 ----")      
S_tot0 = (S_ri0 + S_t + S_cav3 + S_vib)*23.06*1000
S_totf = (S_rif + S_t + S_cav3 + S_vib)*23.06*1000
S_tot1 = (S_ri1 + S_t + S_cav3 + S_vib)*23.06*1000
S_tot2 = (S_ri2 + S_t + S_cav3 + S_vib)*23.06*1000
S_tot3 = (S_ri3 + S_t + S_cav3 + S_vib)*23.06*1000
S_tot4 = (S_ri4 + S_t + S_cav3 + S_vib)*23.06*1000
DS0 = S_tot0 - S_gas
DSf = S_totf - S_gas
DS1= S_tot1 - S_gas
DS2 = S_tot2 - S_gas
...
print(" Test Results: ")
print("DS_sol")
#S_tot = (S_rif + S_t + S_cav2 + S_vib)*23.06*1000
S_tot = (S_rif + S_t + S_cav2 + S_vib)*23.06*1000
#concentration = 1
#c_gas = 1/24.5
DSF = S_tot - S_gas - k*m.log(concentration/c_gas)*23.06*1000
print(DSF)#, S_tot - k*m.log(concentration*24.5)*23.06*1000)
#print(concentration)
