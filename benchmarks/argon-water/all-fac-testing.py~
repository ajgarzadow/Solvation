...
#print("c_gas = ", c_gas)
S_t = k*(m.log(qt) + 1 + 1.5 )#- m.log(concentration/c_gas))
...
#
#nx = m.sqrt(pi*area_solute/(6*vol_solvent))*((psi_solute/psi_solvent)**(3/2))
#fac = (nx**2 + 2*nx)/3
#fac = fac*((((vol_solute**(2/3))/area_solute)/((vol_solvent**(2/3))/area_solvent))**(1/2))
