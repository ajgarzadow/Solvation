...
if (B_av == 0.):
    ...
    S_r_mu = w*S_v + (1-w)*k*(0.5 + m.log(qr_mu)) #- k*m.log(sigma_r)/n_rot
    if (interp_vol):
...
DS2 = DS - S_r + S_rv
DS0 = DS - S_r +S_r_gas
print('%.2f'%DS0,'%.2f'%DS,'%.2f'%DS2)#, S_tot - k*m.log(concentration*24.5)*23.06*1000)
#print(concentration)
