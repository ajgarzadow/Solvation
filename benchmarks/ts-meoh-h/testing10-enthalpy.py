...
dipole_int0 = 1E-30*dipole_solvent*dipole_solvent*(3.335**2)/ \
             (4*pi*epsilon_0*(rc0**3))
if (dipole_int0 > 0 ):
    N_kiss0 = (Delta_H0 - DH_mech0)/(N_Av*dipole_int0*(8/(4*pi)))
else:
    N_kiss0 = 0
dipole_int = 1E-30*dipole_solute*dipole_solvent*(3.335**2)/ \
             (4*pi*epsilon_0*(rc**3))
...
DH_SPT = SPT_G_cav(y,R)*23.06 - T*S_spt/1000
#print(y)
...
print(" FreeRot Mech MechElec")
print(' %.2f'%DS_free,'%.2f'%DS_mech,'%.2f'%DS)
print(" Delta H: ")
